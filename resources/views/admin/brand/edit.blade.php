							...
							<div class="row g-3">
								<div class='col-md-8'>
									<div class='form-row form-group mt-3'>
										...
										<input type="text" class="form-control" name="name" value="{{__($brand->name)}}" id="name01" required>
									</div>
									<div class='form-row form-group mt-3'>
										<label for="meta_title01" class='font-weight-bold form-label'>@lang('Meta_title')</label>
										<input type="text" class="form-control" name="meta_title" value="{{__($brand->meta_title)}}" id="meta_title01" >
									</div>
									<div class='form-row form-group mt-3'>
										<label for="meta_description01" class='font-weight-bold form-label'>@lang('Meta_description')</label>
										<textarea class="form-control " rows="5" name="meta_description"><?php echo $brand->meta_description; ?></textarea>
									</div>
									<div class='form-row form-group mt-3'>
										...
										<select class="select2-auto-tokenize form-control" name="meta_keywords[]" multiple="multiple">
											@if(@$brand->meta_keywords)
												@foreach($brand->meta_keywords as $keyword)
									...
									<div class="form-group row pe-0 mt-3">
					                	<div class="form-group col-md-4 pe-0">
											...
											<div class="">
												<input type="checkbox" name="top_brand" data-width="100%" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Yes" data-off="No" data-size="normal"@if($brand->top_brand) checked @endif>
											</div>
										</div>
									</div>
								</div>
								<div class='col-md-4'>
									<div class='form-group'>
										<div class='image-upload-area'>
											<img id='preview' src="{{ displayImage('assets/images/brands/'.@$brand->image) }}" alt='Image'/>
