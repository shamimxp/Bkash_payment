							...
							<div class="row g-3">
								<div class='col-md-8'>			<td scope='col'>{{ isset($child_category->) ? __($child_category->) : 'N/A' }}</td>
									...
									<div class='form-row form-group mt-3'>
										...
										<input type="text" class="form-control" name="icon" id="icon01" >
									</div>
									<div class='form-row form-group mt-3'>
									...
									<div class='form-row form-group mt-3'>
										...
										<input type="text" class="form-control" name="meta_keywords" id="meta_keywords01" >
									</div>
									<div class='form-row form-group mt-3'>
										<label for="top_category01" class='font-weight-bold form-label'>@lang('Top_category')</label>
										<input type="text" class="form-control" name="top_category" id="top_category01" >
									</div>
									<div class='form-row form-group mt-3'>
										<label for="special_category01" class='font-weight-bold form-label'>@lang('Special_category')</label>
										<input type="text" class="form-control" name="special_category" id="special_category01" >
									</div>
									<div class='form-row form-group mt-3'>
										<label for="filter_category01" class='font-weight-bold form-label'>@lang('Filter_category')</label>
										<input type="text" class="form-control" name="filter_category" id="filter_category01" >
									</div>
								</div>
								<div class='col-md-4'>
