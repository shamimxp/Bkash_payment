        ...
        <div class="row user-dashboard align-items-start">
            ...
            <div class="col-xl-10 col-lg-8 col-md-7">
                <div class="account-book">
                    <div class="user-dashboard-content row">
                        <div class="col-lg-12">
                            <div class="single-default-address billing-address border">
                                <h4>Default Address
                                    <span title="Update shipping address"><i class="fa fa-edit" data-bs-toggle="modal"
                                            data-bs-target="#shippingAddress"></i></span>
                                </h4>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    <div class="material-textfield">
                                                        <input type="email" value="{{__($user->email)}}" name="email">
