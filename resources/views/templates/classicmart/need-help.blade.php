...
@section('content')
    <!-- help start -->
    <div class="help-start text-center section-padding">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="location-content">
                        ...
                        <div class="need-wrapper">
                            <div class="video-main">
                                ...
                                <a target="_blank" href="https://www.youtube.com/watch?v=NPjrFlpf-Rw"
                                   class="need-video video-popup mfp-iframe" data-lity><i class="fa fa-play"></i></a>
                            </div>
                        </div>
                        </a>
                    </div>
